...
Galactic winds are the outflowing gas ejected from galaxies, and they are considered to have a prominent impact on galaxy formation. However, much is to be known from observations about their origin and detailed properties, especially in the early Universe. 

My PhD research on galactic winds is motivated by one question: how and where the winds occur within galaxies in the early Universe. I try to answer the question using the data from a Keck observing program, HALO7D (PI: R. Guhathakurta, UC Santa Cruz), which includes around 200 $z \sim 1$ star-forming galaxies observed with the DEep Imaging Multi-Object Spectrograph (DEIMOS). 
